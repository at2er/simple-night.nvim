...
local function nvim_groups()
  return {
    ...
    TabLine       = { bg = palette.colors.bg, fg = palette.tcolors.bright_white },
    TabLineSel    = { bg = palette.tcolors.blue, fg = palette.tcolors.bright_white },
    ...
    Type        = { fg = palette.tcolors.bright_blue },
    Special     = { fg = palette.tcolors.bright_blue },
